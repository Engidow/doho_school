...
import axios from "axios"; // WAXAA LAGU BEDDELAY AXIOS TOOS AH
...
export default function ContactPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    setLoading(true);
    try {
      // TOOS ULA XIR BACKEND-KA RENDER EE CONTACTS
      await axios.post(
        "https://doha-school-backend.onrender.com/api/contacts",
        form,
        {
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            >
              ...
              {[
                ...
                },
                {
                  icon: FiMapPin,
                  label: "Address",
                  value: "Tabeelaha Sheekh Ibraahim, Mogadishu, Somalia",
                  href: null,
                ...
                <div key={i} className="flex items-start gap-4 p-5 card">
                  ...
                  <div>
                    ...
                    {item.href ? (
                      <a
                        href={item.href}
                        className="font-semibold text-gray-900 dark:text-white hover:text-primary-600 transition-colors text-sm"
                      >
                        {item.value}
                      </a>
                    ) : (
            ...
            <div className="p-5 bg-red-50 dark:bg-red-900/10 rounded-2xl border border-red-100 dark:border-red-800">
              ...
              <p className="text-red-600 dark:text-red-300 text-xs">
                School is currently outside operating hours. We'll respond to
        ...
        <div className="max-w-7xl mx-auto px-4 mt-12">
          <div className="card overflow-hidden rounded-2xl h-72">
            <iframe
              ...
              src="https://maps.google.com/maps?q=Tabeelaha%20Sheekh%20Ibraahim,%20Mogadishu&t=&z=13&ie=UTF8&iwloc=&output=embed"
              width="100%"
              height="100%"
              style={{ border: 0 }}
              allowFullScreen
