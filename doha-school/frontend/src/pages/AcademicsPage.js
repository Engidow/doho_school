...
const steps = [
  {
    ...
    desc: "Fill out the online form below with your child's and parent's details.",
  },
  {
    step: "02",
    title: "Document Review",
    desc: "We review your application and required documents within 3–5 business days.",
  },
  {
    step: "03",
    title: "Entrance Assessment",
    desc: "Student attends a brief assessment appropriate for their grade level.",
  },
  {
    step: "04",
    title: "Enrollment",
    desc: "Receive acceptance letter and complete enrollment with registration fee.",
  },
];
...
export default function AdmissionsPage() {
  ...
  // Helitaanka sanadka hadda la joogo si automatic ah
      ...
      <section className="hero-gradient py-24 relative overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto px-4 text-center text-white">
          ...
          <p className="text-primary-100 text-lg">
            Applications are now open for Grades 1–12. Secure your child's place
            today.
          </p>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {steps.map((s, i) => (
              ...
              >
                <div className="text-5xl font-display font-bold text-primary-100 dark:text-primary-900 mb-4">
                  {s.step}
                </div>
        ...
        <div className="max-w-7xl mx-auto px-4 grid lg:grid-cols-2 gap-16 items-start">
          ...
          >
            ...
            <div className="mt-8 p-6 bg-primary-50 dark:bg-primary-900/20 rounded-2xl border border-primary-100 dark:border-primary-800">
              <h4 className="font-bold text-primary-800 dark:text-primary-200 mb-2">
                Available Grades
              </h4>
