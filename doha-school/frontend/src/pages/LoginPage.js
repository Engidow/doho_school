      ...
      <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}
        ...
        <div className="bg-white dark:bg-gray-800 rounded-3xl shadow-2xl overflow-hidden">
          ...
          <div className="hero-gradient p-8 text-center">
            ...
            <p className="text-primary-200 text-sm">Doha-Model School Management System</p>
          </div>
          ...
          <div className="p-8">
            ...
            <div className="mt-6 p-4 bg-blue-50 dark:bg-blue-900/20 rounded-xl">
              <p className="text-xs text-blue-600 dark:text-blue-400 font-medium mb-1">Default Credentials:</p>
              <p className="text-xs text-blue-500 dark:text-blue-300">Email: admin@dohaschool.com</p>
              <p className="text-xs text-blue-500 dark:text-blue-300">Password: Admin@123</p>
              <p className="text-xs text-gray-400 mt-1">Run <code className="bg-gray-100 dark:bg-gray-700 px-1 rounded">npm run seed</code> in backend first</p>
            </div>
          </div>
        </div>
      </motion.div>
