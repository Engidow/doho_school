...
export default function AdminStudents() {
  ...
  const openEdit = (s) => {
    ...
    setPhotoPreview(s.photo ? getImageUrl(s.photo) : null);
    setPhotoFile(null);
    setShowModal(true);
  };
  ...
  const handleSave = async (e) => {
    ...
    try {
      ...
      if (editing) {
        await api.put(`/students/${editing._id}`, fd, {
    ...
    <div className="space-y-6">
      ...
      <div className="card p-4 flex flex-wrap gap-3">
        ...
        <select
          ...
          className="input-field text-sm w-auto py-2.5"
        >
            ...
            <tbody>
              {loading ? (
                [...Array(5)].map((_, i) => (
                  <tr key={i}>
                    <td colSpan={6}>
                      <div className="h-10 bg-gray-100 dark:bg-gray-700 rounded-lg animate-pulse my-1"></div>
                    </td>
                  </tr>
                ))
              ) : students.length === 0 ? (
                ...
                students.map((s) => (
                  <tr key={s._id}>
                    ...
                    <td>
                      <span
                        className={
                          s.isActive ? "badge badge-green" : "badge badge-red"
                        }
                      >
